...
exports.getModel = function (modelName) {
    return require('app_storefront_controllers/cartridge/scripts/models/' + modelName + 'Model');
};
...
exports.getView = function (viewName, parameters) {
    ...
    try {
        ...
        if (typeof viewName === 'string') {
            View = require('app_storefront_controllers/cartridge/scripts/views/' + viewName + 'View');
        } else {
            // use first argument as parameters if not a string
            // to allow for anonymous views
            parameters = viewName;
            View = require('app_storefront_controllers/cartridge/scripts/views/View');
        }
    } catch (e) {
        View = require('app_storefront_controllers/cartridge/scripts/views/View');
    }
